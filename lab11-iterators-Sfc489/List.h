 ...
 * @brief List Interface specification.
...
public:
    ...
    virtual bool insert(int newPosition, const Object &newEntry) = 0;
    ...
    virtual Object getEntry(int position) const = 0;
    ...
    virtual void replace(int position, const Object &newEntry) = 0;
}; // end List
